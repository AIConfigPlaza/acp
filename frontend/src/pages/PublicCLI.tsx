...
export default function PublicCLI() {
  ...
  const content = {
    en: {
      ...
      heroDesc: "The ACP CLI allows you to sync your AI configurations directly to your local development environment. Pull solutions, agents, prompts, and MCP configurations with a single command.",
      ...
      featureList: [
        ...
        { title: "Version Control", desc: "Track changes and rollback to previous versions" },
        { title: "Team Sharing", desc: "Share configurations across your team seamlessly" },
        { title: "Auto Updates", desc: "Keep your local configs in sync with remote changes" },
      ],
    ...
    zh: {
      ...
      heroTitle: "命令行界面",
      heroDesc: "ACP CLI 允许您将 AI 配置直接同步到本地开发环境。只需一个命令即可拉取方案、Agent、提示词和 MCP 配置。",
      ...
      featureList: [
        ...
        { title: "版本控制", desc: "追踪更改并回滚到之前的版本" },
        { title: "团队共享", desc: "无缝在团队间共享配置" },
        { title: "自动更新", desc: "保持本地配置与远程同步" },
      ],
      backHome: "返回首页",
      docs: "文档",
      loadingDocs: "加载文档中...",
